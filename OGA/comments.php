...
?>
    <div class="oga-comments">
        <h2 class="oga-postheader nocomments"><?php _e('This post is password protected. Enter the password to view any comments.', THEME_NS) ?></h2>
    </div>
<?php
	return;
}
...
?>
    <div class="oga-comments">
        <h2 class="oga-postheader comments"><?php printf(
...
echo str_replace(
    ...
    array('id="respond" class="oga-commentsform"', '<h2', 'id="reply-title" class="oga-postheader"', '</h2>', 'oga-postcontent logged-in-as', 'class="oga-button" type="submit"'), 
    theme_ob_get_clean());